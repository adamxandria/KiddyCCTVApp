...
class ParentLoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val backImageView = findViewById<ImageView>(R.id.backParentImageView)
        ...
        val signupText = findViewById<TextView>(R.id.signupView)
            ...
            FirebaseFirestore.getInstance().collection("users").document(user.uid)
                .get().addOnSuccessListener { documentSnapshot ->
                    ...
                    if (role == "Parent") {
                        ...
                        Toast.makeText(this, "Access denied. You are not registered as a Parent.", Toast.LENGTH_LONG).show()
                    }
